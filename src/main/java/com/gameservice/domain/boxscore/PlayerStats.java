...
public class PlayerStats implements BaseEntity {
	...
	private boolean didNotPlay() {
		// kada budu gotovi minutesPlayed samo to proveriti je l = 0 i znaci da nije
		// igrao
		if (assists == 0 && fieldGoalAttempts == 0 && totalRebounds == 0 && personalFouls == 0 && steals == 0
	...
	public String toString() {
		return didNotPlay() ? player.getName() + ":  " + "---------\t\tDID NOT PLAY\t\t--------"
				: "   |  " + fieldGoals + " |  " + fieldGoalAttempts + " |" + fieldGoalPercentage + "| " + threePointFG
						+ " | " + threePointFGAttempts + "  |" + threePointFGPercentage + "  | " + freeThrows + " | "
						+ freeThrowAttempts + "  |" + freeThrowPercentage + "| " + offensiveRebounds + " | "
