...
public interface TeamMapper extends BaseMapper<Team> {
  ...
  @Update("update basketball_teams set name=#{name},teamId=#{teamId}, modified_on=current_timestamp where team_id = #{teamId}")
  ...
  @Results(value = {
      ...
      @Result(property = "createdOn", column = "created_on"),
      @Result(property = "modifiedOn", column = "modified_on"),
      @Result(property = "teamId", column = "team_id"), @Result(property = "name", column = "name"),
      @Result(property = "seasonYear", column = "season_year"),
      @Result(property = "players", javaType = List.class, column = "team_id",
          many = @Many(select = "getPlayersForTeam", fetchType = FetchType.LAZY))
  })
   ...
   * @Result(property = "modifiedOn", column = "modified_on"),
   * 
   * @Result(property = "name", column = "name"), @Result(property = "teamId", column = "team_id"),
   * 
   * @Result(property = "players", javaType = List.class, column = "id", many = @Many(select =
   * "getPlayersForTeam", fetchType = FetchType.LAZY)) })
   * 
   ...
   * 
   * @Select("select p.* from players p where p.team_id = #{teamId}") public List<Player>
   * getPlayersForTeam(@Param("teamId") String teamId);
   */
