...
public class PlayerStatsRepository implements BaseRepository<PlayerStats> {
  ...
  public int insert(PlayerStats entity) throws SQLIntegrityConstraintViolationException {
    ...
    PlayerStats playerStats =
        getByMatchIdAndPlayerId(entity.getPlayer().getPlayerId(), entity.getMatch().getMatchId());
  ...
  public int insertMatchStats(List<PlayerStats> homeTeamPlayerStats,
      List<PlayerStats> awayTeamPlayerStats) {
